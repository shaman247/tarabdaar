...
peak measures −80/−88/−93/−102 dBFS at 1/2/3/5 blocks. Shipped:
**3 blocks** (`StringVoiceSource.settleBlocks`, ~60% of the prior
rebuild latency), guarded by an absolute −80 dBFS publish bar in
`RebuildCostTests` (the old relative A/B became a meaningless ratio of
noise floors). The silent publish also lets the quiescence gate close
