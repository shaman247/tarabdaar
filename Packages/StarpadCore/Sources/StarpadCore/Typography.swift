...
///
/// Display text (titles, headlines, the Live tab's big readouts, the
/// calibration numerals) is deliberately NOT scaled: it is already legible,
/// and growing it would reflow the panels.
